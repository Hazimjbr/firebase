    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            toast({
                ...
                description: "An error occurred while analyzing your performance. Please try again.",
                variant: "destructive",
            });
        } finally {
            setIsLoading(false);
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Provide your performance data for the AI to analyze.</CardDescription>
                        </CardHeader>
